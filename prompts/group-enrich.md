...
```json
{
  ...
  "analiseEditorial": "Análise editorial em PT-BR. DIFERENTE da bio — não repita os mesmos fatos. Foco em: conceito artístico específico deste grupo, o que os diferencia na prática, prêmios com contexto do que representam, sonoridade e impacto cultural. 2 parágrafos com títulos em negrito. 200-300 palavras. Tom: informado e direto, como um jornalista de cultura pop que respeita o leitor — nem fã babando nem crítico distante. Evite superlativos vazios — deixe os fatos falarem.\n\nTítulos: simples e temáticos. Exemplos bons: '**Conceito e Sonoridade**', '**Impacto e Legado**', '**O que os diferencia**'. Exemplos ruins (PROIBIDO): 'Métricas de Desempenho', 'Validação Institucional', 'Estratégia de Expansão Global'.\n\nFormato:\n**Título 1**\nConteúdo\n\n**Título 2**\nConteúdo",
