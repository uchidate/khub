...
export const ARCHIVE_HUBS: ArchiveHub[] = [
    ...
    },
    {
        ...
        faq: [
            { question: 'Who are the members of Stray Kids?', answer: 'Stray Kids is composed of eight members — Bang Chan, Lee Know, Changbin, Hyunjin, Han, Felix, Seungmin and I.N — each with active solo and production work alongside group activities.' },
    ...
    },
    {
        ...
        faq: [
            { question: '¿Quiénes son los integrantes de Stray Kids?', answer: 'Stray Kids está formado por ocho integrantes —Bang Chan, Lee Know, Changbin, Hyunjin, Han, Felix, Seungmin e I.N— cada uno con trabajo activo en solitario y producción además de las actividades grupales.' },
