...
# Script de limpeza INTERATIVO - mostra o que será deletado e pede confirmação
...
# 6. Estimativa de espaço que será liberado
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📊 RESUMO:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# Calcula espaço estimado
RECLAIMABLE=$(docker system df --format "{{.Reclaimable}}" | tail -1 | sed 's/[^0-9.]//g')
echo "💰 Espaço estimado a liberar: ~$(docker system df --format "{{.Reclaimable}}" | tail -1)"
echo ""
...
docker images ghcr.io/uchidate/khub --format "{{.ID}}" | tail -n +4 | xargs -r docker rmi -f 2>/dev/null || echo "   ⚠️  Algumas imagens podem estar em uso (ignorando)"
