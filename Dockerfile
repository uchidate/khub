...
ARG NEXT_PUBLIC_ADSENSE_SLOT_AUTO
ARG NEXT_PUBLIC_ADSENSE_SLOT_ANCHOR
ARG NEXT_PUBLIC_ADSENSE_SLOT_SIDE_RAIL
ARG NEXT_PUBLIC_ADSENSE_SLOT_SIDEBAR
ARG NEXT_PUBLIC_ADSENSE_SLOT_FLUID
...
ENV NEXT_PUBLIC_ADSENSE_SLOT_AUTO=$NEXT_PUBLIC_ADSENSE_SLOT_AUTO
ENV NEXT_PUBLIC_ADSENSE_SLOT_ANCHOR=$NEXT_PUBLIC_ADSENSE_SLOT_ANCHOR
ENV NEXT_PUBLIC_ADSENSE_SLOT_SIDE_RAIL=$NEXT_PUBLIC_ADSENSE_SLOT_SIDE_RAIL
ENV NEXT_PUBLIC_ADSENSE_SLOT_SIDEBAR=$NEXT_PUBLIC_ADSENSE_SLOT_SIDEBAR
ENV NEXT_PUBLIC_ADSENSE_SLOT_FLUID=$NEXT_PUBLIC_ADSENSE_SLOT_FLUID
