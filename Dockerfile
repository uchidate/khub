...
ARG NEXT_PUBLIC_ADSENSE_SLOT_BLOG_ARTICLE
ARG NEXT_PUBLIC_ADSENSE_SLOT_ARTIST
ARG NEXT_PUBLIC_ADSENSE_SLOT_GROUP
ARG NEXT_PUBLIC_ADSENSE_SLOT_PRODUCTION
ARG NEXT_PUBLIC_ADSENSE_SLOT_AGENCY
ARG NEXT_PUBLIC_ADSENSE_SLOT_CONTACT
ARG NEXT_PUBLIC_ADSENSE_SLOT_NEWS_LIST
ENV NEXT_PUBLIC_ADSENSE_CLIENT=$NEXT_PUBLIC_ADSENSE_CLIENT
ENV NEXT_PUBLIC_ADSENSE_SLOT_BLOG_ARTICLE=$NEXT_PUBLIC_ADSENSE_SLOT_BLOG_ARTICLE
ENV NEXT_PUBLIC_ADSENSE_SLOT_ARTIST=$NEXT_PUBLIC_ADSENSE_SLOT_ARTIST
ENV NEXT_PUBLIC_ADSENSE_SLOT_GROUP=$NEXT_PUBLIC_ADSENSE_SLOT_GROUP
ENV NEXT_PUBLIC_ADSENSE_SLOT_PRODUCTION=$NEXT_PUBLIC_ADSENSE_SLOT_PRODUCTION
ENV NEXT_PUBLIC_ADSENSE_SLOT_AGENCY=$NEXT_PUBLIC_ADSENSE_SLOT_AGENCY
ENV NEXT_PUBLIC_ADSENSE_SLOT_CONTACT=$NEXT_PUBLIC_ADSENSE_SLOT_CONTACT
ENV NEXT_PUBLIC_ADSENSE_SLOT_NEWS_LIST=$NEXT_PUBLIC_ADSENSE_SLOT_NEWS_LIST
