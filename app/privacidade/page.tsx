      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-black text-foreground uppercase italic tracking-tight leading-none mb-4">
            Política de<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-[#ff6fa3]">
              Privacidade
            </span>
          </h1>
            ...
            <Section id="cookies" title="Cookies e rastreamento">
              ...
              <div className="space-y-3">
                <div className="p-4 bg-surface border border-border rounded-xl">
                  <p className="font-bold text-foreground mb-1">Essenciais</p>
                  <p>Necessários para o funcionamento do site (sessão de login, preferências de tema). Não podem ser desativados.</p>
                </div>
                <div className="p-4 bg-surface border border-border rounded-xl">
                  <p className="font-bold text-foreground mb-1">Analíticos (Google Analytics 4)</p>
