          ...
          <article className="flex-1 space-y-10">
            ...
            <Section id="contato" title="Contato e DPO">
              ...
              <ul className="list-none space-y-1">
                <li><strong className="text-zinc-300">Encarregado (DPO):</strong> <a href="mailto:privacidade@hallyuhub.com.br" className="text-pink-400 hover:underline">privacidade@hallyuhub.com.br</a></li>
