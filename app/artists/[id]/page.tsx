    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="relative h-[65vh] md:h-[75vh] overflow-hidden">
                ...
                <div className="absolute top-16 md:top-20 left-0 right-0 px-4 sm:px-12 md:px-20 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 sm:gap-2 z-10">
