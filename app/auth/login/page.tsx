          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative flex items-center">
                <Mail className="absolute left-3.5 text-zinc-500 pointer-events-none z-10 shrink-0" size={16} />
                <input
                  type="email"
                  value={values.email}
                  ...
                  required
                  disabled={isLoading}
                  className="w-full pl-10 pr-4 py-2.5 text-sm bg-zinc-900 border border-zinc-800 rounded-xl text-white placeholder:text-zinc-600 focus:outline-none focus:border-purple-500/60 focus:ring-1 focus:ring-purple-500/20 transition-all"
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <Lock className="absolute left-3.5 text-zinc-500 pointer-events-none z-10 shrink-0" size={16} />
                <input
                  type="password"
