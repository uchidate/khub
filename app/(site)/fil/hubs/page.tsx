...
const strings = HUB_INDEX_UI_STRINGS.fil

export const metadata: Metadata = {
    title: strings.metaTitle,
    description: strings.metaDescription,
    alternates: { canonical: `${BASE_URL}/fil/hubs` },
}

export default function HubsIndexPageFil() {
    return <HubsIndexContent locale="fil" hubs={getArchiveHubsByLocale('fil')} />
}
