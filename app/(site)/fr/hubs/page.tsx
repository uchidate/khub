...
const strings = HUB_INDEX_UI_STRINGS.fr

export const metadata: Metadata = {
    title: strings.metaTitle,
    description: strings.metaDescription,
    alternates: { canonical: `${BASE_URL}/fr/hubs` },
}

export default function HubsIndexPageFr() {
    return <HubsIndexContent locale="fr" hubs={getArchiveHubsByLocale('fr')} />
}
