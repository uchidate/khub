...
export default function ArtistEnrichQueuePage() {
    ...
    return (
        <AdminLayout title="Enriquecimento de Artistas">
                ...
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <h1 className="text-xl font-black text-foreground flex items-center gap-2">
                            ...
                            Enriquecimento de Artistas
                        </h1>
                        <p className="text-sm text-muted mt-0.5">
                            Gere o JSON no Gemini com <code className="text-xs bg-surface-hover px-1 rounded">prompts/idol-enrich.md</code> e aplique aqui.
                        </p>
                    </div>
                    <button
