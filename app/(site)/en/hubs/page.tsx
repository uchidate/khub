...
const strings = HUB_INDEX_UI_STRINGS.en

export const metadata: Metadata = {
    title: strings.metaTitle,
    description: strings.metaDescription,
    alternates: { canonical: `${BASE_URL}/en/hubs` },
}

export default function HubsIndexPageEn() {
    return <HubsIndexContent locale="en" hubs={getArchiveHubsByLocale('en')} />
}
