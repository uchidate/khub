...
function LoginForm() {
  ...
  const handleSpotifySignIn = async () => {
    ...
    try {
      ...
      setError('Erro ao entrar com Spotify')
      setIsLoading(false)
    }
  }
        ...
        <div className="flex-1 flex items-center justify-center p-8 lg:p-10 bg-background">
          <div className="w-full max-w-sm">
            ...
            <button
              ...
              className="w-full mb-3 py-3 bg-background border border-border text-foreground text-sm font-semibold rounded-xl hover:bg-surface disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2.5"
            >
              <GoogleIcon />
            ...
            <button
              onClick={handleSpotifySignIn} disabled={isLoading}
