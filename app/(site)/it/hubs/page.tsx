...
const strings = HUB_INDEX_UI_STRINGS.it

export const metadata: Metadata = {
    title: strings.metaTitle,
    description: strings.metaDescription,
    alternates: { canonical: `${BASE_URL}/it/hubs` },
}

export default function HubsIndexPageIt() {
    return <HubsIndexContent locale="it" hubs={getArchiveHubsByLocale('it')} />
}
