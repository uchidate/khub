...
import { CalendarDays, Film, Music2, Newspaper, ShoppingBag, Users } from "lucide-react"
...
const DISCOVERY_SHORTCUTS = [
    { label: "Artigos", href: "/blog", icon: Newspaper, detail: "Leituras e análises" },
    ...
    { label: "Loja", href: "/loja", icon: ShoppingBag, detail: "Achados K-pop" },
]
    ...
    return (
        <section className="bg-background py-4 sm:py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* MAIN HERO */}
                <div className="overflow-hidden rounded-2xl border border-border bg-background shadow-sm lg:min-h-[438px] flex flex-col">
                ...
                {/* RIGHT COLUMN */}
                <div className="overflow-hidden rounded-2xl border border-border bg-background shadow-sm flex flex-col">
                    ...
                    {/* Artist Spotlight */}
                        {spotlightArtist ? (
                        <div className="p-4 bg-background text-foreground flex flex-col gap-3">
                            {/* Label */}
                ...
                <div className="mt-4 overflow-hidden rounded-2xl border border-border bg-background shadow-sm">
                    <div className="flex items-center justify-between px-3.5 sm:px-5 py-2.5 border-b border-border bg-surface">
                    ...
                    <div className="grid grid-cols-2 bg-background sm:grid-cols-3 lg:grid-cols-6">
                        {DISCOVERY_SHORTCUTS.map(({ label, href, icon: Icon, detail }, idx) => (
                            <Link
                                key={href}
                                href={href}
                                className={`group flex min-h-[78px] flex-col justify-center gap-1.5 px-4 py-3 transition-colors hover:bg-surface
                                    ${idx % 2 === 0 ? 'border-r border-border' : ''}
                                    ${idx < 4 ? 'border-b border-border sm:border-b-0' : ''}
                                    ${idx < 3 ? 'sm:border-r sm:border-border' : ''}
                                    ${idx < 5 ? 'lg:border-r lg:border-border' : ''}
                                `}
                            >
