    ...
    return (
        <section className="bg-background">
            <div className="mx-auto max-w-[1440px] border-y border-border bg-background">
                ...
                <div className="grid border-t border-border bg-surface/55 lg:items-start lg:grid-cols-[minmax(0,1.55fr)_minmax(280px,0.7fr)] xl:grid-cols-[minmax(0,1.55fr)_minmax(330px,0.75fr)]">
