            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="overflow-hidden rounded-2xl border border-border bg-background shadow-[0_1px_0_rgba(15,23,42,0.04)]">
                    <div className="flex items-center gap-2 border-b border-border px-4 py-3 sm:px-6">
                        ...
                        <div>
                            <p className="text-[9px] font-bold uppercase tracking-[0.14em] text-pink-400">Calendário</p>
                    ...
                    <div className="flex gap-2.5 overflow-x-auto p-4 sm:gap-3 sm:p-5">
                        {artists.map(artist => (
                            <Link
                                ...
                                className="group flex-shrink-0 w-20 sm:w-24 rounded-xl overflow-hidden border border-border hover:border-pink-500/40 transition-all duration-300"
                            >
