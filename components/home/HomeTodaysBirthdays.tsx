        ...
        <section className="bg-background py-5 sm:py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="overflow-hidden rounded-2xl border border-border bg-background shadow-sm">
                    <div className="flex items-center gap-2 border-b border-border bg-surface px-4 py-3 sm:px-6">
                    ...
                    <div className="flex gap-2.5 overflow-x-auto p-4 sm:gap-3 sm:p-5">
                        {artists.map(artist => (
                            <Link
                                ...
                                className="group flex-shrink-0 w-20 sm:w-24 rounded-xl overflow-hidden border border-border hover:border-accent/50 transition-all duration-300"
                            >
