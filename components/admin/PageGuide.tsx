        ...
        <div className="mb-5 rounded-xl border border-zinc-800/60 bg-zinc-900/40 overflow-hidden">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-semibold text-zinc-400 group-hover:text-zinc-300 transition-colors">
                        {title}
                    </span>
                    {!open && (
                        <span className="text-[11px] text-zinc-600 hidden sm:inline truncate max-w-[400px]">
                            — {description}
                        </span>
                    )}
                </div>
            ...
            {open && (
                <div className="px-4 pb-4 space-y-4 border-t border-zinc-800/60">
                    ...
                    {/* Flow steps */}
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-zinc-600 mb-2">Fluxo</p>
                    ...
                    {tips && tips.length > 0 && (
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-zinc-600 mb-2">Dicas</p>
