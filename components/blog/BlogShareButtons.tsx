...
export function BlogShareButtons({ title, url, compact }: BlogShareButtonsProps) {
  ...
  return (
    <div className={`flex items-center gap-2 flex-wrap ${compact ? '' : ''}`}>
      ...
      <a
        ...
        className={`flex items-center gap-1.5 rounded-md bg-surface text-muted transition-all hover:bg-surface-hover hover:text-foreground ${compact ? 'p-2' : 'px-3 py-1.5 text-[11px] font-semibold'}`}
