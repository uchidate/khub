...
export function StreamingTopShows({ showsByPlatform }: StreamingTopShowsProps) {
    ...
    return (
        <div>
            {/* Header */}
            <div className="flex items-center justify-between gap-2 border-b border-violet/20 bg-surface-media px-4 py-2.5 sm:px-6">
                <span className="shrink-0 text-[9px] font-bold uppercase tracking-[0.13em] text-violet">
