                ...
                {productions.map((production, index) => (
                    ...
                    >
                        ...
                        >
                            <div className="relative aspect-[2/3] rounded-2xl overflow-hidden bg-[#080808] mb-3 shadow-lg">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-3 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                                    <div className="flex items-center gap-2 text-xs text-[#e8e8e8]">
                                        <span className="px-2 py-0.5 bg-[#ff2d78]/80 backdrop-blur-sm rounded-full font-bold">
                                            {production.type}
                                        </span>
                                        {production.year && (
                            ...
                            {/* Title */}
                            <div className="px-1">
                                <h3 className="text-white font-bold text-sm group-hover:text-[#ff2d78] transition-colors line-clamp-2 leading-tight">
                                    {production.titlePt}
                                </h3>
