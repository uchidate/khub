        ...
        <section>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 mb-5">
                <div className="flex items-center gap-2">
                    <div className="p-1.5 bg-[#ff2d78]/20 rounded-lg">
                ...
                {/* Tabs */}
                <div className="flex items-center gap-1 bg-[#080808]/60 border border-white/5 rounded-xl p-1">
                ...
                <Link
                    href="/productions"
                    className="ml-auto text-xs font-black text-muted hover:text-white uppercase tracking-widest transition-colors hidden sm:block"
                >
                    Ver todos →
                </Link>
            </div>
                    ...
                    >
                        <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-[#080808] mb-2 shadow-md">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-2 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                                <div className="flex items-center gap-1 text-[10px] text-[#e8e8e8] flex-wrap">
                                    <span className="px-1.5 py-0.5 bg-[#ff2d78]/80 backdrop-blur-sm rounded font-bold">
                                        {prod.type}
                                    </span>
                                    {prod.year && (
                        ...
                        <h3 className="text-white font-bold text-xs group-hover:text-[#ff2d78] transition-colors line-clamp-2 leading-tight px-0.5">
                            {prod.titlePt}
                        </h3>
                    </Link>
                ))}
