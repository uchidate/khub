    ...
    return (
        <div className="mb-10 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 flex items-center gap-2 bg-zinc-900/50 border border-white/10 rounded-xl px-4 focus-within:border-purple-500/50 focus-within:ring-2 focus-within:ring-purple-500/20 transition-all">
