...
import { Search, User, LogOut, LayoutDashboard, ChevronRight, X } from "lucide-react"
...
export const MobileMenu = ({ links: _links }: MobileMenuProps) => {
  ...
  const drawer = open && mounted ? createPortal(
    <div className="fixed inset-0 z-[9999] lg:hidden" role="dialog" aria-modal="true" aria-label="Menu principal">
      {/* Backdrop */}
      <div
